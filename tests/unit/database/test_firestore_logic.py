...
def test_get_collection_instruments():
    ...
    assert test_ci_metadata[0] == {"ci_version": 1, "data_version": "0.0.1", "validator_version": "0.0.1", "classifier_type": "form_type",
    ...
    assert test_ci_metadata[1] == {"ci_version": 1, "data_version": "0.0.1", "validator_version": "0.0.1", "classifier_type": "form_type",
